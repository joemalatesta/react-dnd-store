export const inventory = [
  ...
  {name:'Flask', cost:'2 cp', weight:'1 lb.'},
  {name:'Hammer', cost:'1 gp', weight:'3 lb.'},
  {name:'Healers Kit', cost:'5 gp', weight:'3 lb.'},
  {name:'Potion of Healing', cost:'50 gp', weight:'.5 lb.'},
  {name:'Pouch', cost:'5 sp', weight:'1 lb.'},
  {name:'Quiver', cost:'1 gp', weight:'1 lb.'},
  {name:'Rations(1 day)', cost:'5 sp', weight:'2 lb.'},
  {name:'Rope (50ft)', cost:'1 gp', weight:'10 lb.'},
  {name:'Short Sword', cost:'10 gp', weight:'2 lb.'},
  ...
  {name:'Vial (empty)', cost:'1 gp', weight:'-'},
  {name:'Waterskin', cost:'2 sp', weight:'5 lb.(full)'},
  {name:'Whetstone', cost:'1 cp', weight:'1 lb'},
] 